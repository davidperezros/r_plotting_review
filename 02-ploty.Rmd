...
```{r, caption= "Población de España. Fuente: INE", webshot = "webshot",out.width = "800%"}
...
```{r, out.width="100%",fig.cap="Flujos de personas en el mercado laboral en España 2024 T2",webshot="webshot"}
